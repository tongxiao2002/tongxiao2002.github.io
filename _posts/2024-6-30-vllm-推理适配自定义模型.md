...
`vllm` 官方也给出了一个非常粗略的适配自定义模型的[文档](https://docs.vllm.ai/en/latest/models/adding_model.html)，但看这意思其实还是得自己啃源代码然后自己改才能适配，并没有提供一个用户友好的借口。
...
LLaVAR Github Repo: https://github.com/SALT-NLP/LLaVAR 
LLaVAR Huggingface Repo: https://huggingface.co/SALT-NLP/LLaVAR_delta
